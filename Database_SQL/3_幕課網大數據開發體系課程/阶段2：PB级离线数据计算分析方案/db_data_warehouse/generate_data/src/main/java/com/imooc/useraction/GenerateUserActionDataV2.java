...
public class GenerateUserActionDataV2 {
    private final static Logger logger = LoggerFactory.getLogger(GenerateUserActionDataV2.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        if(!flag){
            ...
            int[] actArr = GenerateDateAndActArrUtil.getActArr();
            for(int i=0;i<dateArr.length;i++){
                ...
                for(int j=0;j<actArr.length;j++){
                    ...
                    String hdfsOutPath = "hdfs://bigdata01:9000/data/ods/user_action/"+dt.replace("-","")+"/"+act;
